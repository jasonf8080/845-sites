    ...
    <div className="relative mx-auto max-w-[1600px] min-h-[calc(100vh-88px)]">
      ...
      <div className="grid items-end gap-8 pt-6 md:grid-cols-[1.2fr_0.8fr] md:pt-10">
        <div className="relative z-10">
          <h1 className="max-w-[900px] text-[3.2rem] font-black leading-[0.88] tracking-[-0.08em] text-white md:text-[6.4rem]">
          ...
          <div className="mt-8 flex items-end gap-0 md:mt-10">
            <span className="text-[7rem] font-black leading-[0.8] tracking-[-0.09em] text-[#ff6e3c] md:text-[18rem]">
              D
            </span>
            <span className="pb-4 text-[3.2rem] font-black leading-[0.82] tracking-[-0.08em] text-white md:pb-8 md:text-[6.5rem]">
              evelopment
            </span>
          </div>
        </div>
